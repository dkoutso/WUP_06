...
the Fisher exact tests tells us that the whites are mostly in favor of capitol punishment as compared to the blacks and the other races.  
the p-value of the fisher's exact test is 0.02479 which is less than 0.05, so we reject the null hypothesis.  
